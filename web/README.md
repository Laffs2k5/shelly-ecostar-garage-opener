...
neon theme, the **animated door graphic** (opening/closing), the **morphing action button** (Open / Close /
**Stop** / Engage; STOPPED = an Open｜Close split), a connection footer with history, and a **demo mode**
(local simulation, no broker) — all driven
